...
def test_basic_metrics():
    ...
    assert Metrics.percentile(wealths, 50) == pytest.approx(350.0) # Median of 300 and 400
...
def test_savings_gap_logic():
    ...
    FV = PMT * ((1 + r)^n - 1) / r
    """
    market = MarketConfig("Stock", 0.07, 0.0, 1.0) # 0 volatility for deterministic test

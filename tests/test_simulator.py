...
def test_zero_growth_scenario():
    ...
    total_savings = working_years * (config.initial_salary * config.savings_rate) # $200,000
    
    retirement_years = config.end_age - config.retirement_age # 35 years
    expected_terminal_wealth = total_savings * ((1 - config.withdrawal_rate) ** retirement_years)
